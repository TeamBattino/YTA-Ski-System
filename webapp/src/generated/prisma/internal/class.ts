...
const config: runtime.GetPrismaClientConfig = {
  "generator": {
    ...
    "output": {
      "value": "/mnt/c/Projects/Projects_Google/YTA-Ski-System/webapp/src/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/mnt/c/Projects/Projects_Google/YTA-Ski-System/webapp/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativePath": "../../../prisma",
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client\"\n  output   = \"../src/generated/prisma\"\n}\n\ndatasource db {\n  provider  = \"postgresql\"\n  url       = env(\"DATABASE_URL\")\n  directUrl = env(\"DIRECT_URL\")\n}\n\nmodel User {\n  id            String          @id @default(cuid())\n  name          String?\n  email         String          @unique\n  emailVerified DateTime?\n  image         String?\n  accounts      Account[]\n  sessions      Session[]\n  // Optional for WebAuthn support\n  Authenticator Authenticator[]\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\nmodel Account {\n  userId            String\n  type              String\n  provider          String\n  providerAccountId String\n  refresh_token     String?\n  access_token      String?\n  expires_at        Int?\n  token_type        String?\n  scope             String?\n  id_token          String?\n  session_state     String?\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@id([provider, providerAccountId])\n}\n\nmodel Session {\n  sessionToken String   @unique\n  userId       String\n  expires      DateTime\n  user         User     @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\nmodel VerificationToken {\n  identifier String\n  token      String\n  expires    DateTime\n\n  @@id([identifier, token])\n}\n\n// Optional for WebAuthn support\nmodel Authenticator {\n  credentialID         String  @unique\n  userId               String\n  providerAccountId    String\n  credentialPublicKey  String\n  counter              Int\n  credentialDeviceType String\n  credentialBackedUp   Boolean\n  transports           String?\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@id([userId, credentialID])\n}\n\nmodel racer {\n  name     String? @db.VarChar(255)\n  ldap     String? @db.VarChar(255)\n  racer_id String  @id @default(dbgenerated(\"gen_random_uuid()\")) @db.Uuid\n  ski_pass String  @db.VarChar(255)\n  run      run[]\n  location String? @db.VarChar(255)\n  race     race?   @relation(fields: [race_id], references: [race_id], onDelete: Cascade, onUpdate: Cascade)\n  race_id  String  @db.Uuid\n\n  @@unique([race_id, ski_pass], name: \"racer_identifier\")\n}\n\nmodel run {\n  start_time DateTime? @db.Timestamp(6)\n  duration   Int?\n  ski_pass   String    @db.VarChar(255)\n  run_id     String    @id @default(dbgenerated(\"gen_random_uuid()\")) @db.Uuid\n  racer      racer     @relation(fields: [race_id, ski_pass], references: [race_id, ski_pass], onDelete: Cascade, onUpdate: Cascade)\n  race       race?     @relation(fields: [race_id], references: [race_id], onDelete: Cascade, onUpdate: Cascade)\n  race_id    String    @db.Uuid\n}\n\nmodel race {\n  race_id String  @id @default(dbgenerated(\"gen_random_uuid()\")) @db.Uuid\n  name    String? @unique @db.VarChar(255)\n  racer   racer[]\n  run     run[]\n}\n\nmodel admin {\n  admin_id String @id @default(dbgenerated(\"gen_random_uuid()\")) @db.Uuid\n  email    String @unique\n}\n",
  "inlineSchemaHash": "965b8d49cc5bec9a070f981316c1ff088daf81c60804d8e23d4e3cd2d8befd44",
  "copyEngine": true,
  "runtimeDataModel": {
    "models": {},
    "enums": {},
...
/**
  ...
  /**
   * `prisma.racer`: Exposes CRUD operations for the **racer** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more Racers
    * const racers = await prisma.racer.findMany()
    * ```
    */
  get racer(): Prisma.racerDelegate<ExtArgs, { omit: OmitOpts }>;
